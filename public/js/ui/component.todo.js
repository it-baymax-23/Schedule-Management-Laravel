!function (t) {
    ...
    var o = function () {
        ...
        }, {id: "4", text: "Testing??", done: !0}, {id: "5", text: "Hehe!! This looks cool!", done: !1}, {
            id: "6",
    ...
    o.prototype.markTodo = function (t, o) {
        ...
        this.generate(), this.$archiveBtn.on("click", function (t) {
            ...
            return t.preventDefault(), "" == o.$todoInput.val() || void 0 === o.$todoInput.val() || null == o.$todoInput.val() ? (o.$todoInput.focus(), !1) : (o.addTodo(o.$todoInput.val()), !0)
        })
