                    ...
                    <h4 class="page-title">
                        ...
                        @if($currantWorkspace && $currantWorkspace->permission == 'Owner')
                            <a href="#" class="btn btn-success btn-sm ml-3" data-ajax-popup="true" data-size="lg"
                               ...
                               data-url="{{route('tasks.create',[$currantWorkspace->slug,$project->id])}}">{{ __('Add New')}}</a>
                        @endif
                    </h4>
                </div>
            </div>
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="dropdown float-right">
                                                    ...
                                                    @if($currantWorkspace->permission == 'Owner')
                                                        <!-- item-->
                                                        <a href="#" class="dropdown-item" data-ajax-popup="true" data-size="lg" data-title="{{ __('Edit Task') }}" data-url="{{route('tasks.edit',[$currantWorkspace->slug,$taskDetail->project_id,$taskDetail->id])}}"><i
                                                                    class="mdi mdi-pencil mr-1"></i>{{__('Edit')}}</a>
                                                        <!-- item-->
                                                        <a href="#" class="dropdown-item" onclick="(confirm('Are you sure ?')?document.getElementById('delete-form-{{$taskDetail->id}}').submit(): '');"><i
                                                ...
                                                @if($currantWorkspace->permission == 'Owner')
                                                <p class="mb-0">
                                                    <img @if($taskDetail->user->avatar) src="{{asset('/storage/avatars/'.$taskDetail->user->avatar)}}" @else avatar="{{ $taskDetail->user->name }}" @endif alt="user-img"
