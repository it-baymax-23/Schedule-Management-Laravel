    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" id="start_date" name="start_date" value="{{$project->start_date}}" >
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="end_date">{{ __('End Date') }}</label>
                <input class="form-control date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" id="end_date" name="end_date" value="{{$project->end_date}}" >
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
