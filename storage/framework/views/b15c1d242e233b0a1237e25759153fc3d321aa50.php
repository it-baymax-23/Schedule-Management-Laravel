        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo e($task->due_date); ?>" class="form-control form-control-light date" id="due_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" name="due_date" required>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\taskly\resources\views/projects/taskEdit.blade.php ENDPATH**/ ?>