<?php $__env->startSection('content'); ?>
    ...
    <!-- title-->
    <h4 class="mt-0"><?php echo e(__('Free Sign Up')); ?></h4>
    <p class="text-muted mb-4"> <?php echo e(__('Don\'t have an account? Create your account, it takes less than a minute')); ?></p>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="username" type="text" id="username" placeholder="<?php echo e(__('Enter Your Username')); ?>" value="<?php echo e(old('username')); ?>" required autocomplete="username">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" type="email" id="emailaddress" placeholder="<?php echo e(__('Enter Your Email')); ?>" value="<?php echo e(old('email')); ?>" required autocomplete="email">
