    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
               ...
               <input type="hidden" value="true" name="app_debug"/>
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/taskly-submitted/site/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>