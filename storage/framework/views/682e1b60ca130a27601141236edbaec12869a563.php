...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        <div class="col-sm-4">
            <button type="button" class="btn btn-danger btn-rounded mb-3" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create new')); ?>" data-url="<?php echo e(route('create_lang_workspace',$currantWorkspace->slug)); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\taskly\resources\views/lang/index.blade.php ENDPATH**/ ?>