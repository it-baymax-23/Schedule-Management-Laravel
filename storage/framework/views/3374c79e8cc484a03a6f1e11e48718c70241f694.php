...
<script src="<?php echo e(asset('js/vendor/bootstrap-tagsinput.min.js')); ?>"></script>
<!-- third party js ends -->
...
<script>
    var UserNames = new Bloodhound({
        ...
        prefetch: {
            url: '<?php echo e(route('user.email.json')); ?>',
            cache:false,
...
</script><?php /**PATH C:\xampp\htdocs\taskly\resources\views/users/invite.blade.php ENDPATH**/ ?>