    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" id="start_date" name="start_date" value="<?php echo e($project->start_date); ?>" >
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="end_date"><?php echo e(__('End Date')); ?></label>
                <input class="form-control date" data-provide="datepicker" data-date-format="yyyy-mm-dd" type="text" id="end_date" name="end_date" value="<?php echo e($project->end_date); ?>" >
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
...
</form><?php /**PATH C:\xampp\htdocs\taskly\resources\views/projects/edit.blade.php ENDPATH**/ ?>